...
export default {
  ...
  methods: {
    goToAddDoctors() {
      this.$router.push({ name: "addDoctors" });
    },

    goToEditDoctors() {
      this.$router.push({ name: "editDoctors" });
    },

    goToViewRecords() {
      this.$router.push({ name: "viewDoctorsRecords" });
    },
  },
};
</script>
